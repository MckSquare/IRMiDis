...
training_set = nltk.classify.apply_features(trainObj.get_feature_vector(train_tweets), train_tweets)
test_set = nltk.classify.apply_features(trainObj.get_feature_vector(test_tweets), test_tweets)
